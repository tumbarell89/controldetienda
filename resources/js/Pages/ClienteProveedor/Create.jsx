...
export default function Create({ auth, dclienteproveedor }) {
    ...
    <Authenticated
      ...
      header={
        <h2 className="font-semibold text-xl text-gray-800 leading-tight">
          Create Dclienteproveedor
        </h2>
      }
    >
      <Head title="Create Dclienteproveedor" />
      <div className="py-12">
            ...
            <div className="w-full">
              <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                  <h1 className="text-base font-semibold leading-6 text-gray-900">Create Dclienteproveedor</h1>
