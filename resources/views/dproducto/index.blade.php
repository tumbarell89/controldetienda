                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Dproductos') }}</h1>
                        ...
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
									...
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Codigoproducto</th>
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Unidadmedida</th>
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Dtipogiros Id</th>
                                    ...
                                    @foreach ($dproductos as $dproducto)
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $dproducto->codigoproducto }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $dproducto->unidadmedida }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $dproducto->dtipogiros_id }}</td>
                                ...
                                <div class="mt-4 px-4">
                                    {!! $dproductos->withQueryString()->links() !!}
                                </div>
                            </div>
                        </div>
                    </div>
