...
export default function Adicionar({ auth, ntipogiros, nunidadmedidas }) {
  const { data, setData, post, errors } = useForm({
    denominacion: "",

    dtipogiro_id: "", // Cambiamos `id_giro` a `giro_id` para que sea más claro
    nunidadmedida_id: "", // Cambiamos `id_giro` a `giro_id` para que sea más claro
  });
